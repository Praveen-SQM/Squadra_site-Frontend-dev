...
export default function ContactUsForm() {
    ...
    return (
        <div className="w-[1440px] h-[900px] bg-[#06135B] flex pt-[60px] pl-[120px] pr-[124px] justify-between">
            {/* Left Section */}
            ...
            {/* Right Section */}
            <div className="w-[677px] h-[715px] bg-[#FFFFFF] mt-[12px] py-[63px] px-[32px]">
                <div className="mb-10">

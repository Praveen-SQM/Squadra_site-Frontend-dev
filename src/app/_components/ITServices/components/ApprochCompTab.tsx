...
const ApprochCompTab = () => {
  ...
  return (
    <div className="flex bg-white  mx-auto p-6 py-[62px] gap-2">
      {/* Left Section */}
      ...
      {/* Right Section */}
      <div className="l md:flex flex-col gap-[12px] w-[321px] md:mt-0">
        <Image

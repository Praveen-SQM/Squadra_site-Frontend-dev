...
export default function ContactUsForm() {
  ...
  return (
    <div
      id="contact-section"
      className="max-w-screen-2xl flex flex-col py-[42px] px-[20px] lg:flex-row  md:mt-0 justify-between gap-[20px] bg-[#FAFAFA]"
    >
      {/* Left Section */}
      ...
      <div className="w-full lg:w-1/2">
        ...
        <form onSubmit={handleSubmit(onSubmit as SubmitHandler<FormData>)}>
          ...
          <Button
            disabled={loading}
            type="submit"
            className="w-full h-[48px] rounded-[4px] py-[16px] px-[24px]"
          >

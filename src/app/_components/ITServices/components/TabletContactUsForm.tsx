...
export default function ContactUsForm() {
  ...
  return (
    <div
      id="contact-section"
      className="w-full h-[1180px] bg-[#06135B] flex flex-col pt-[60px] mx-auto justify-center items-center"
    >
      {/* Left Section */}
        ...
        <form onSubmit={handleSubmit(onSubmit as SubmitHandler<FormData>)}>
          ...
          <div className="flex justify-end">
            <Button
              disabled={loading}
              type="submit"
              className="w-[188px] h-[48px] rounded-[8px] py-[16px] px-[24px] bg-[#06135B]"
            >

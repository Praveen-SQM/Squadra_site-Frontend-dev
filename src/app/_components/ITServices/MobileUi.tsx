...
export const data = [
  ...
  },
  {
    ...
    description:
      "Leveraging data and AI to drive smarter decisions and automation.",
  },
  {
    icon: codeSquare,
    title: "Web & Mobile Application Development",
    description: "Creating fast, intuitive web and mobile apps.",
  },
  {
    icon: Saas,
    title: "SaaS Development",
    description:
      "Scalable, cloud-based applications for subscription-based services.",
  },
  {
    icon: UserWorkFlow,
    title: "End-to-End IT Services",
    description: "Complete IT support from design to deployment and security.",
  },
  {
    icon: Connection,
    title: "Industry-Specific Solutions",
    description:
      "Customised solutions for finance, healthcare, and other industries.",
  },
];
...
export const saasData = [
  {
    icon: DB,
    title: "Subscription Management Solutions",
    description:
      "Streamline subscriptions with efficient tools for tracking, billing, and renewals.",
  },
  {
    icon: CloudConnection,
    title: "Cloud-Based Applications",
    description:
      "Leverage scalable, secure, and accessible solutions powered by the cloud.",
  },
  {
    icon: Graphs,
    title: "Data-Driven SaaS Tools",
    description: "Personalise your profile with themes and layouts.",
  },
  {
    icon: CustomServices,
    title: "Custom Integration Services",
    description:
      "Connect systems to streamline workflows and improve data sharing.",
  },
];
...
export const webAndMobDev = [
  {
    ...
    description:
      "Delivering speed and reliability for seamless user experiences.",
  },
  {
    icon: crossPlatforms,
...

  {
    ...
    description:
      "Building robust and scalable APIs for seamless integration across platforms.",
  },
];
...
export const healthcare = [
  ...
  },
  {
    ...
    description:
      "Streamline healthcare workflows for efficiency and better care.",
  },
  {
    icon: healthRecords,
...
export const aiAndDigital = [
  {
    ...
    description:
      "Automate tasks with AI to boost efficiency and reduce human error.",
  },
  {
    icon: workflow,
    title: "Workflow Optimization Tools",
    description:
      "Streamline processes and improve team collaboration for higher productivity.",
  },
  {
    icon: digitaltransformation,
    title: "Complete Digital Transformation Strategies",
    description:
      "Implement digital solutions to drive growth and innovation across your business.",
  },
  {
    icon: cloud,
    title: "Cloud Integration Solutions",
    description:
      "Integrate cloud technologies for enhanced scalability and operational flexibility.",
  },
];
...
export const finTech = [
  ...
  },
  {
    ...
    description:
      "Experience effortless, contactless payments with digital wallets.",
  },
  {
    icon: financial,
    title: "Financial Analytics",
    description:
      "Gain insights with real-time analytics for smarter decisions.",
  },
  {
    icon: invoice,
...
export const cloudData = [
  {
    ...
    description:
      "Provide scalable, flexible cloud services to meet business needs.",
  },
  {
    icon: architecturedesign,
    title: "Architecture Design",
    description:
      "Design scalable cloud infrastructures for optimal performance.",
  },
  {
    icon: clouddev,
    title: "Cloud Dev",
    description:
      "Develop cloud-native applications with agility and innovation.",
  },
  {
    icon: cloudsecurity,
    title: "Cloud Security",
    description:
      "Ensure robust protection for data and applications in the cloud.",
  },
];
  ...
  return (
    <div className="h-fit  flex flex-col  w-full  items-center bg-[#040206]">
      ...
      <div className="relative h-screen  w-full overflow-hidden">
        ...
        {/* Content */}
        <div className="flex flex-col pt-[230px] absolute inset-0 mt-[clamp(80px,20vw,200px)] gap-[clamp(28px,6vw,60px)] px-[clamp(12px,5vw,24px)]">
          ...
          text-[36px] leading-[clamp(32px,8.5vw,52px)]"
              >
      ...
      <p className="text-center mt-[13px] text-white text-[32px] font-bold leading-[38.19px]">
        What we do
      </p>

      <div className="w-[335px] h-[34px] gap-0 mt-[12px]">
        <p className="text-center text-[#797B85] text-[14px] font-medium leading-[17.08px]">
      ...
      <div className="mt-[42px]">
        {data?.map((el, index) => (
          <div
            ...
            } h-[128px] p-[16px] gap-[8px] rounded-[16px] border-t-[1px] border-transparent`}
          >
            {/* ✅ Extra image only for index 0 */}
            {index === 0 && (
              <div className="absolute inset-0 opacity-20 rounded-[16px] overflow-hidden z-0 transition-all duration-300">
                <Image
                  ...
                  alt="Background GIF"
                  fill
                  className="object-cover scale-[0.6] transform"
                />
              </div>
            )}
            ...
            <div className="flex gap-[8px]">
              <div className="w-[44px] h-[44px] flex items-center justify-center bg-[#18181A] border-[2px] border-[#28282C] rounded-[10.62px]">
                <Image src={el?.icon} width={23} height={23} alt="Network" />
              </div>
      ...
      <div className="w-[335px] h-[124px] mt-[42px] mb-[72px] flex flex-col items-center justify-center">
        <p className="text-left text-[14px] font-normal leading-[24px] text-[#888888] uppercase">
          ...
          {customSoftwareDevData?.map((el) => (
            ...
            >
              <div className="flex gap-[8px]">
                ...
                <div className="w-[237px] h-[38px]  flex items-center justify-left">
                  <p className="text-[#222222] text-start  text-[16px] font-medium leading-[19.09px]">
                    {el?.title}
                  </p>
                </div>
              </div>
      ...
      <div className="pt-[44px] pb-[40px] px-[18px] flex flex-col gap-[24px] bg-[#F7F7F7]">
        <div className="flex flex-col gap-[12px] items-center justify-center">
          <p className="font-semibold text-[32px] leading-[38.19px] text-center text-[#FBAE17]">
            Squadra{" "}
            <span className="font-semibold text-[32px] leading-[38.19px] text-center text-[#131313]">
              Tech Team
            </span>
          </p>
      ...
      <div className="bg-white w-full flex items-center justify-center flex-col">
        <div className="mt-[72px] flex flex-col gap-[12px] w-[335px] h-[101px] mb-[40px] ">
          <p className="font-sans text-[32px] font-semibold leading-[38.19px] text-center text-[#131313]">
            Why Choose{" "}
            <span className="font-sans text-[32px] font-semibold leading-[38.19px] text-center text-[#FBAE17]">
              Us
            </span>
          </p>
      ...
      <div className="bg-[#FAFAFA] min-w-[360px] w-full flex flex-col items-center justify-center">
        <div className="w-[335px] h-[118px] mt-[42px]">
          ...
          <p className="w-[335px] h-[68px] mt-[12px] text-[#6D6D6D] text-center text-[14px] font-normal leading-[16.71px] ">
            Discover the cutting-edge technologies we use to deliver innovative
            and impactful solutions, from modern frameworks to advanced cloud
              ...
              <AccordionContent className="bg-[#FAFAFA]">
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {backendTools.map((item) => (
                    <div
                      key={item.name}
                      className="w-[171px] h-[120px] flex items-center justify-center bg-white"
                    >

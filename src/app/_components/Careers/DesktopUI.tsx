        ...
        <div className='flex flex-col justify-center'>
            ...
            <div className='w-full flex flex-col items-center'>
                <div className='flex flex-col py-[72px] xl:px-[124px] lg:px-[0px] md:px-[0px] gap-[42px] xl:w-[1192px] lg:w-[714px] md:w-[714px] sm:w-[335px] w-[335px]'>
                    <div className='flex flex-col gap-[72px] justify-center'>
                        <p className='font-[300] xl:text-[62px] lg:text-[48px] md:text-[48px] xl:leading-[50px] lg:leading-[50px] md:leading-[50px] sm:text-[28px] sm:leading-[33.41px] text-[28px] leading-[33.41px] text-[#131313] text-center'>Current openings</p>
                        <div>
                            {jobSections?.map((item, index) => (
                                <div key={index} className={`border-b ${index === 0 ? "border-t" : ""} ${openIndexes.includes(index) ? "border-t border-[#06135B]" : "border-[#E7E7E7]"}`}>
                                    ...
                                    >
                                        <span className="xl:text-[24px] xl:leading-[28.64px] lg:text-[24px] lg:leading-[28.64px] md:text-[24px] md:leading-[28.64px]  sm:text-[16px] sm:leading-[19.09px] text-[#3D3D3D] font-medium">{item.title}</span>
                                                ...
                                                <li className='border-b border-[#B0B0B0] flex justify-between xl:py-[16px] lg:py-[16px] md:py-[16px] sm:py-[8px] py-[8px] xl:pl-[40px] xl:pr-[32px] lg:pl-[40px] lg:pr-[32px] md:pl-[40px] md:pr-[32px]'>
                                                    <div className='flex flex-col justify-between gap-[2px]'>
                                                        ...
                                                        <div className='flex items-center xl:gap-3 lg:gap-3 md:gap-3 sm:gap-1 gap-1'>
                                                            ...
                                                            <div className='border-l border-[#D1D1D1] py-1 xl:pl-4 lg:pl-4 md:pl-4 sm:pl-1 pl-1 font-[300] xl:text-[14px] xl:leading-[16.71px] lg:text-[14px] lg:leading-[16.71px] md:text-[14px] md:leading-[16.71px] sm:text-[12px] sm:leading-[14.32px] text-[12px] leading-[14.32px] text-[#4F4F4F]'>5+ Years of Experience</div>
                                                        </div>
                                                    </div>
                    ...
                    <div className='w-full flex justify-end'>
                        <div onClick={() => router.push('/openings')} className='xl:w-[194px] lg:w-[194px] md:w-[194px] sm:w-full w-full h-[58px] flex justify-center items-center rounded-[4px] gap-2 bg-[#131313] cursor-pointer'>
                        ...
                        {employeeBenefits?.map((benefit, index) => (
                            <div key={index} className={`xl:h-[460px] xl:w-[397.33px] lg:h-[309px] lg:w-[357px] md:h-[309px] md:w-[357px] sm:w-[335px] w-[335px] flex flex-col items-center xl:pt-[72px] xl:pb-[64px] xl:px-[44px] xl:gap-[40px] lg:pt-[40px] lg:pb-[40px] lg:px-[32px] lg:gap-[32px] md:pt-[40px] md:pb-[40px] md:px-[32px] md:gap-[32px]  sm:pt-[32px] sm:pb-[32px] sm:px-[32px] sm:gap-[32px] pt-[32px] pb-[32px] px-[32px] gap-[32px] ${index % 2 === 0 ? 'bg-[#FFFFFF]' : 'bg-[#FAFAFA]'}`}>
                                ...
                                <div className='flex flex-col xl:gap-5 lg:gap-5 md:gap-5 sm:gap-3 gap-3'>
                                    ...
                                    <p className='font-normal xl:text-[18px] xl:leading-7 lg:text-[16px] lg:leading-[23px] md:text-[16px] md:leading-[23px] sm:text-[14px] sm:leading-[19px] text-[14px] leading-[19px] text-[#6D6D6D]'>{benefit?.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <div className='w-full bg-[#FFFFFF] xl:py-[72px] lg:py-[72px] md:py-[72px] sm:py-[40px] py-[40px] xl:px-[124px] lg:px-[60px] md:px-[60px] sm:px-[20px] px-[20px] flex flex-col gap-[44px] items-center'>
                <div className='flex flex-col xl:gap-[44px] lg:gap-[44px] md:gap-[44px] sm:gap-[32px] gap-[32px] xl:w-[1192px] lg:w-[714px] md:w-[714px]'>
                    ...
                    <div className='flex flex-col xl:gap-3 lg:gap-3 md:gap-3 sm:gap-[40px] gap-[40px]'>


                        <div className='flex flex-col gap-3'>
                            <div className='flex xl:flex-row lg:flex-row md:flex-row sm:flex-col flex-col items-center gap-3'>
                                <div className='flex xl:flex-col lg:flex-col md:flex-col sm:flex-row flex-row gap-3'>
                            ...
                            <div className='flex xl:flex-row lg:flex-row md:flex-row sm:flex-col flex-col items-center gap-3'>
                                <div className='rounded-[6px] xl:w-[760px] lg:w-[420px] md:w-[420px] xl:h-[400px] lg:h-[400px] md:h-[400px] sm:h-[200px] h-[200px] bg-gray-400 hidden sm:block'>
                                    <Image src="https://squadra-media.s3.ap-south-1.amazonaws.com/tinified+(1)/2.1.webp" alt='Life at Squadra' width={760} height={400} className="xl:w-[760px] lg:w-[420px] md:w-[420px] xl:h-[400px] lg:h-[400px] md:h-[400px] sm:h-[200px] h-[200px] object-cover" />
                                </div>
                                <div className='flex xl:flex-col lg:flex-col md:flex-col sm:flex-row flex-row gap-3'>
                                    <div className='rounded-[6px] xl:w-[420px] h-[194px] lg:w-[282px] md:w-[282px] sm:w-[163.5px] w-[163.5px] bg-gray-400'>

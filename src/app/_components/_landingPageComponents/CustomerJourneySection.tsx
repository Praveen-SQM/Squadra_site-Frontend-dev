  ...
  const services = [
    {
      ...
      description:
        "Our team designs logos that capture your vision and values.",
      image:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/tinified+(1)/brand.webp",
      video:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/1112893_Teamwork_Coworking_1920x1080_1_9d0e3b0d07+(1).mp4",
    },
    {
      ...
      video:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/7011693_Filmmaker_Cameraman_1920x1080_ee89e46b34.mp4",
    },
    {
      ...
      image:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/tinified+(1)/website.webp",
      video:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/1112819_Concentration_Teamwork_3840x2160_4065f959c6.mp4",
    },
    {
      ...
      video:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/1473075_People_Business_1920x1080_6675f77d8b.mp4",
    },
    {
      ...
      image:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/tinified+(1)/relation.webp",
      video:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/1471741_People_Business_1920x1080_712aeda6f4.mp4",
    },
    {
      ...
      video:
        "https://squadra-media.s3.ap-south-1.amazonaws.com/1114499_Plan_Architecture_1920x1080_42270b2ae3.mp4",
    },
  ];

  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 xl:px-4 py-32 flex flex-col gap-8 rounded">
      <div className="space-y-2">
        <p className="sm:text-sm text-[11px] font-medium text-gray-600 uppercase tracking-wider">
          CUSTOMER JOURNEY
        </p>
        <h2 className="sm:text-3xl text-[24px] leading-8 md:text-4xl font-semibold">
          How <span className="text-[#FBAE17]">Squadra Media</span> Drives Your
          Growth.
        </h2>
      </div>

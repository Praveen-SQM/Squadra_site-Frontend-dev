import { TrendingUp, Users, Eye, Smartphone, Globe } from "lucide-react";
...
const caseStudies = [
  {
    ...
    challenge: "When Oia launched in Bangalore, the challenge was massive—87,000 sq. ft., premium pricing, surrounded by top pubs, and zero digital presence.",
    solution: "Squadra rebuilt their entire social identity from scratch with a content + cinematic + performance system designed for fast visibility.",
    whatWeDid: [
    ...
    insight: "Because we didn't \"post content.\" We built a brand experience, optimized for F&B virality and conversion.",
  ...
  },
  {
    ...
    challenge: "When Seaverse set out to modernize maritime training, they needed more than just content. They needed a complete digital ecosystem.",
    ...
    insight: "Training, technology, content, and marketing were all built under one roof. No fragmentation. No delays. Just one aligned growth system.",
    cta: "",
  },
  {
    ...
    challenge: "Prime Golf needed to transform from a sports facility into a premium lifestyle brand that resonates with their target audience.",
    solution: "We partnered with Prime Golf to craft a social media experience that matched their premium positioning.",
    whatWeDid: [
    ...
    insight: "Prime Golf became the blueprint for how regional businesses can scale digitally with Squadra's ecosystem.",
    cta: "",
  },
];
...
const CaseStudies = () => {
  return (
    <section id="case-studies" className="py-20 lg:py-28 relative overflow-hidden bg-[hsl(var(--squadra-gray))]">
      <div className="container relative">
        <div className="max-w-3xl mx-auto text-center mb-14">
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 text-[hsl(var(--squadra-dark))]">
            Case Studies That <span className="text-gradient">Define Growth</span>
          </h2>
        </div>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      <p className="text-xs font-semibold text-[hsl(var(--squadra-dark))] uppercase tracking-wider mb-1">The Challenge</p>
                      <p className="text-sm text-muted-foreground">{study.challenge}</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-[hsl(var(--squadra-dark))] uppercase tracking-wider mb-1">Our Approach</p>
                      <p className="text-sm text-muted-foreground">{study.solution}</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-[hsl(var(--squadra-dark))] uppercase tracking-wider mb-2">What We Did</p>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border mb-4">
                    {study.results.map((result, j) => (
                      <div key={j} className="text-center">
                        ...
                        <p className="text-xl font-display font-bold text-[hsl(var(--squadra-gold))]">{result.value}</p>
                        <p className="text-[10px] text-muted-foreground uppercase">{result.label}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="bg-[hsl(var(--squadra-gray))] rounded-xl p-4">
                    <p className="text-xs font-semibold text-[hsl(var(--squadra-gold))] uppercase tracking-wider mb-1">Why It Worked</p>
                    <p className="text-sm text-[hsl(var(--squadra-dark))] italic">{study.insight}</p>
                  </div>

                  {study.cta && (
                    <p className="text-sm text-muted-foreground mt-4 font-medium">{study.cta}</p>
                  )}
                </div>
              </div>
            </div>

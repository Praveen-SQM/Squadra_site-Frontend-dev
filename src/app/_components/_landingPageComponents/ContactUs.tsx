...
export default function ContactSection() {
  ...
  return (
    <section className="bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 xl:px-4 py-16 flex items-center xl:justify-between lg:justify-center mb-8 mt-4 md:mt-0 md:mb-12 rounded">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="relative group">
            <div className="bg-white rounded-3xl transition-all duration-300">
              <div className="rounded-2xl overflow-hidden">
                <Image
                  src={
                    "https://squadra-media.s3.ap-south-1.amazonaws.com/tinified+(1)/contact.webp"
                  }
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Feel free to reach out with any thoughts, questions, or
              suggestions. Whether it&apos;s a brief conversation or a deeper
              discussion, we&apos;re here to connect.
            </p>

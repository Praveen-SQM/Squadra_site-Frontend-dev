  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Orbital/Circular Layout - Desktop - Perfectly Centered */}
        <div className="hidden lg:block relative h-[600px] max-w-5xl mx-auto mb-20">
          {/* Orbital circle - perfectly centered */}
          ...
          {/* Satellite nodes - Balanced positioning */}
          {[
            ...
            const x = 50 + (radius / 5) * Math.cos(angleRad);

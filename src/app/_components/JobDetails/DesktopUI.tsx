    ...
    return (
        <div className='my-[80px]'>
            <div className='pt-[32px] pb-[44px] lg:px-[124px] md:px-[60px] sm:px-[20px] px-[20px] flex items-center lg:gap-3 md:gap-3 sm:gap-2 gap-2'>
                ...
                <Image src={applyIcon} alt='apply' width={18} height={18} />
                <p className='font-medium lg:text-[16px] lg:leading-6 md:text-[16px] md:leading-6 sm:text-md text-md sm:leading-6 text-[#1E3A76] cursor-pointer'>Sr. UI/UX Designer</p>
            </div>
            <div className='lg:pt-[60px] md:pt-[60px] sm:pt-[40px] pt-[40px] pb-[40px] lg:ml-[124px] md:ml-[60px] sm:ml-[20px] ml-[20px] lg:w-[60%] md:w-[714px]'>
                <div className='flex flex-col lg:gap-[40px] md:gap-[40px] sm:gap-[16px] gap-[16px]'>
                    <div className='flex flex-col lg:gap-[12px] md:gap-[12px] sm:gap-[4px] gap-[4px]'>
                        <p className='font-medium lg:text-[40px] lg:leading-[47.73px] md:text-[40px] md:leading-[47.73px] sm:text-[20px] sm:leading-[23.87px] text-[20px] leading-[23.87px] text-[#3D3D3D]'>Senior UI/UX designer</p>
                        <div className='flex items-center lg:gap-6 md:gap-6 sm:gap-1 gap-1'>
                            <p className='font-normal lg:text-[24px] lg:leading-[28.64px] md:text-[24px] md:leading-[28.64px] sm:text-[12px] sm:leading-[14.32pxpx] text-[#4F4F4F]'>Bengaluru</p>
                            <div className='w-[1px] h-[21px] bg-[#B0B0B0]'></div>
                            <p className='font-normal lg:text-[24px] lg:leading-[28.64px] md:text-[24px] md:leading-[28.64px] sm:text-[12px] sm:leading-[14.32pxpx] text-[#4F4F4F]'>Full Time</p>
                            <div className='w-[1px] h-[21px] bg-[#B0B0B0]'></div>
                            <p className='font-normal lg:text-[24px] lg:leading-[28.64px] md:text-[24px] md:leading-[28.64px] sm:text-[12px] sm:leading-[14.32pxpx] text-[#4F4F4F]'>3+ Years Of Experience</p>
                        </div>
                    </div>
